...
export function TemplatesMenu() {
  ...
  return <div className="templates-root" ref={root}>
    <Button ref={trigger} variant="ghost" onClick={() => setOpen((value) => !value)} aria-label="Открыть шаблоны" aria-expanded={open} aria-haspopup="dialog" title="Шаблоны"><LayoutTemplate size={17} aria-hidden="true" /><span className="desktop-label">Шаблоны</span></Button>
